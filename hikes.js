...
//     for (i in hikeList){
//       let hikePicture = `https://byui-cit.github.io/cit261/examples/${hikeList[i].imgSrc}`
    
//       let hikeDetails = document.createElement('div')
//       let hikeHeader = document.createElement('h2')
    
//       let hikeImg = document.createElement('img')
//       hikeImg.setAttribute('src', hikePicture)
//       hikeImg.setAttribute('alt', hikeList[i].imgAlt)
    
//       hikeHeader.innerHTML = hikeList[i].name
//       hikeDetails.appendChild(hikeHeader)
//       hikeDetails.appendChild(hikeImg)
    
//       page.appendChild(hikeDetails)}
